...
export default function CanvasPage() {
  ...
  const generateImage = async () => {
    ...
    const promptToUse = selectedImage
  ...
  const handleImageUpload = async (e) => {
    ...
    await supabase
      .from("images_created")
      .insert([{ url: imageUrl, canvas_id: canvas }])
      .select();
    setLoading(false);
    fetchNewImages();
  };
  return (
    <div
      className="min-h-screen bg-black items-center 
    justify-center flex flex-col w-full bg-black text-white"
    >
      {/* header */}
      <Header />
      <div
        className="min-h-screen bg-black grid
      ...
      >
        ...
        {loading ? (
          <div
            className="col-span-3 items-center justify-center w-full
          ...
          <div
            className="col-span-3 items-center justify-start w-full
                 flex flex-col min-h-screen border-x border-white/5 pt-12 relative"
          >
            {!selectedImage && (
              <div
                className="w-full py-1 items-center
                         justify-end flex px-5 absolute top-2"
              >
                <p
                  className="label text-blue-600"
            ...
            {selectedImage && (
              <div
                className="w-full flex border-b pb-4 border-white/5 absolute top-5
              ...
              >
                <div className="items-center justify-start flex space-x-3 ">
                  ...
                  <Dialog className="" open={OpenDialog}>
                    ...
                    <DialogContent
                      ...
                      className="bg-black text-white py-12 filter
                ...
                <p
                  ...
                  className="cursor-pointer smooth hover:scale-95"
                >
                  X
                </p>
              </div>
        ...
        {/* image parameters */}
        <div
          className="col-span-1 min-h-screen 
                overflow-y-auto py-12 px-6 space-y-8"
        >
              ...
              {dimensions.map((dimension) => (
                <div
                  ...
                  className={`text-sm px-4 py-1 border border-white/10
                                     items-center hover:bg-white/50 hover:text-black
                                      smooth cursor-pointer
                                    justify-center flex
                                     ${imageParams.dimension.height ==
                      dimension.height &&
                      imageParams.dimension.width ==
                      dimension.width
